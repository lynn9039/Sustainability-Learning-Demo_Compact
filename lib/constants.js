...
export const COMPACT_MAX_TOKENS = 9_000;
export const DEMO_MAX_CONTENT_CHARS = 4_000;
export const GENERATION_MODE =
  process.env.GENERATION_MODE === "full" ? "full" : "compact";
export const COMPACT_MAX_CONTENT_CHARS = 2_200;
export const COMPACT_ANTHROPIC_TIMEOUT_MS = 55_000;
...
export const ERROR_STATUS = {
  ...
  [ERROR.CONTENT_TOO_LONG]: 400,
  [ERROR.GENERATION_TIMEOUT]: 504,
...
export const ERROR_HINTS = {
  ...
  [ERROR.CONTENT_TOO_LONG]:
    "The content is too long for the public compact demo. Please paste a shorter excerpt so Claude can return within the Vercel Hobby runtime.",
  [ERROR.GENERATION_TIMEOUT]:
    "Claude needed too much time to process this content, so Vercel could not return the HTML page. Try a shorter, more focused excerpt.",
};
